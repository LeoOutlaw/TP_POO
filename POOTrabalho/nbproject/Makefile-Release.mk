...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pootrabalho.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pootrabalho.exe: ${OBJECTFILES}
...
${OBJECTDIR}/CrazyPiloto.o: CrazyPiloto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CrazyPiloto.o CrazyPiloto.cpp
...
${OBJECTDIR}/RapidoPiloto.o: RapidoPiloto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RapidoPiloto.o RapidoPiloto.cpp

${OBJECTDIR}/SurpresaPiloto.o: SurpresaPiloto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SurpresaPiloto.o SurpresaPiloto.cpp

${OBJECTDIR}/TextUI.o: TextUI.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextUI.o TextUI.cpp
